    ...
    <main className="min-h-screen flex items-center justify-center bg-[#FFF8F0] p-4">
      <section className="bg-white rounded-xl border-2 border-black shadow-2xl w-full max-w-md overflow-hidden">
        ...
        >
          ...
          <div className="mb-6">
            <label htmlFor="confirmar_password" className="block text-black font-medium mb-2">
          ...
          <LoadingButton
            type="submit"
            loading={loading}
            className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg"
          >
            Crear cuenta
          </LoadingButton>
