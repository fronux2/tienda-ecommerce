...
import PasswordCoincidencia from '@/components/PasswordCoincidencia'
...
export default function RegistroPage() {
  ...
  const confirmacion = watch('confirmar_password') ?? ''
  ...
  const onSubmit = async (data: RegistroSchema) => {
    ...
    try {
      ...
      // registrarAction redirects on success/error
    }
    setLoading(false)
  }
    ...
    <main className="min-h-screen flex items-center justify-center bg-cream p-4">
      <section className="bg-surface rounded-xl border-2 border-ink shadow-2xl w-full max-w-md overflow-hidden">
        <header className="bg-primary py-6 text-center border-b-2 border-ink">
          <h1 className="text-2xl font-bold text-white">Crear cuenta en MangaNihon</h1>
        </header>
        ...
        >
          ...
          <div className="mb-6">
            <label htmlFor="password" className="block text-ink font-medium mb-2">
              Contraseña
            </label>
            <div className="relative">
              <input
          ...
          <div className="mb-6">
            <label htmlFor="confirmar_password" className="block text-ink font-medium mb-2">
            ...
            <PasswordCoincidencia password={password} confirmacion={confirmacion} />
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-surface text-text-muted">¿Ya tienes cuenta?</span>
            </div>
          </div>
