...
export default function About() {
    return (
        <section id="about" className="min-h-screen flex items-center justify-center bg-cream py-20 px-4">
            <div className="flex flex-col md:flex-row items-center bg-surface rounded-xl shadow-xl border-2 border-ink p-6 md:p-12 max-w-6xl w-full">
                ...
                <div className="flex-1 flex flex-col items-center md:items-start">
                    ...
                    <p className="text-lg text-text mb-8 text-center md:text-left leading-relaxed">
                    ...
                    <div className="flex flex-col items-center mt-4">
                        ...
                        <span className="font-bold text-ink text-lg">Marcos Muñoz</span>
                        <span className="text-primary font-medium">Fundador</span>
                    </div>
